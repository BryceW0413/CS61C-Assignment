...
/* It creats a memorary space in stack but it will be released and can not be reused 
if the function is finished. Its value can be changed */
...
/* This function returns a pointer, which represents the beginning of memory space
for vector_t in stack, but this space will still be released and its values can be 
modified */
